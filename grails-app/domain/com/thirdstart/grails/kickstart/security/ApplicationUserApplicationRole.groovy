...
class ApplicationUserApplicationRole implements Serializable {
	...
	static boolean exists(long applicationUserId, long applicationRoleId) {
		criteriaFor(applicationUserId, applicationRoleId).count()
	}

	private static DetachedCriteria criteriaFor(long applicationUserId, long applicationRoleId) {
